...
$qry = "SELECT * FROM absen_pelatihan WHERE nim = '$nim'";
$exec = mysqli_query($con, $qry);
$data = mysqli_fetch_assoc($exec);

?>
    <div class="sectionform">
    <form action="absenupdate.php" method="POST">
        <fieldset>
            <legend>Form Absensi</legend>
             ...
             <table>
                ...
                <tr>
                    <td>Tanggal</td>
                    <td>:</td>
                    <td><input type="date" name="tanggal" value="<?= $data['tanggal']?>">
                    </td>
                </tr>
                <tr>
                    <td>Unit</td>
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td><input type="text" name="bukti_hadir"value="<?= $data['bukti_hadir']?>"></td>
                </tr>
                </tr>
                    <td></td>
                    <td></td>
