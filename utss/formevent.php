...
<div class="sectionform">
    <form action="prosesevent.php" method="POST">
        <fieldset>
    ...
    <?php
        include "koneksi.php";
        $qry = "SELECT * FROM partisipasi_event";
    ...
    <tr>
         ...
         <td><?= $data['event']?></td>
         <td>
         <a href="editevent.php?nim=<?= $data['nim']?>"><button>Edit</button></a>
         <a href="deleteevent.php?nim=<?= $data['nim']?>"><button>Delete</button></a>
        </td>
    </tr>
    <?php } ?>
    </table>
